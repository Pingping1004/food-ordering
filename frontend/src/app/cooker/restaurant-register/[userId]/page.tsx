        ...
        <div>
            <form onSubmit={handleSubmit(submitData, onError)} className="flex flex-col gap-y-10 py-10 px-6">
                <header className="flex flex-col gap-y-1">
                    <h1 className="text-2xl text-primary font-noto-thai text-bold">ข้อมูลร้านอาหาร</h1>
                ...
                <section className="flex flex-col gap-y-6">
                    <div className="flex gap-x-2 items-end">
                        <h2 className="text-lg text-primary font-noto-thai text-bold">เลือกประเภทของร้านอาหาร</h2>
                ...
                <main className="flex flex-col gap-y-6">
                    <h2 className="text-lg font-noto-thai text-bold">ช่วงเวลาเปิดร้าน</h2>
                ...
                <section className="flex flex-col gap-y-6">
                    <h2 className="font-noto-thai text-bold  text-primary">ข้อมูลติดต่อผู้ดูแลร้าน</h2>
                    <div className="grid grid-cols-2 gap-x-4">
                        <div>
                            <Input
                                type="text"
                ...
                <section className="flex flex-col gap-y-6">
                    <div className="flex items-center gap-x-1">
                        <h2 className="font-noto-thai text-bold  text-primary">บัญชีรับเงิน</h2>
